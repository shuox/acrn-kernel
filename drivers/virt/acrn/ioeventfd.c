...
/**
 * struct hsm_ioeventfd - Private structure of ioeventfd
 * @list: List node to link the hsm_ioeventfd
 * @eventfd: eventfd of ioeventfd object
 * @addr: Address of I/O range
 * @data: Data for matching
 * @length: Length of I/O range
 * @type: Type of I/O range
...
void acrn_ioeventfd_deinit(struct acrn_vm *vm)
{
	...
	pr_debug("VM %d ioeventfd deinit.\n", vm->vmid);
